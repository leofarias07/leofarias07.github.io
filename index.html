...
<!-- Use any element to open the sidenav -->
    <div class="menu mt-5 d-none d-sm-block">
    <span onclick="openNav()"><i class="fas fa-bars fa-2x"> MENU</i> </span>
    </div>

      <div class="menu mt-5 mb-3 text-center d-block d-sm-none">
    <span onclick="openNav()"><i class="fas fa-bars fa-2x"> MENU</i> </span>
    </div>
...
<!-- Add all page content inside this div if you want the side nav to push page content to the right (not used if you only want the sidenav to sit on top of the page -->
   ...
   <div class="col-md-4 p-2 d-none d-sm-block " >
    <div class="social p-2 " style=" text-align:right;">
        <div class="d-inline-block "><i class="fab fa-facebook-square"></i></div>
        <span class="d-sm-inline-block "><i class="fab fa-instagram"></i></span>
        <span class="d-md-inline-block "><i class="fab fa-youtube-square"></i></span>
    </div>
    <div class="p-1" align="right" style="color:#fff"><i class="far fa-clock"></i> Domingo,    23 de setembro de 2018 </div>
  ...
  <div class="input-group floar-right">
   <input class="form-control" type="text" placeholder="O que você procura?" style="width: 200px;
    ...
    <section class="mt-4"> <!-- Primeiro post  -->
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-12">
            <div class="media">
              <img class="img-fluid" src="imagens/post1.jpg" alt="Generic placeholder image">
             </div>
           </div> 
           <div class="col-md-9">    
    ...
    </section><!-- FIM Primeiro post  -->

    <section class="mt-4"><!--Inicio sessao 1-->
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="card">
    ...
    <section class="mt-4"><!--Inicio sessao da 2-->
      <div class="container">
        <div class="row">
    ...
    <section><!--Inicio sessão Variedades-->
                ...
                <ul class="list-group">
                  <li class="list-group-item" style="background:#6f93b7" >
                      <table>
                        <tbody>
                          <tr>
                            <td><h1 style="margin:0; font-size:56px; color:#fff; font-weight:bold;  margin-right:15px; text-align:center;">01</h1></td>
                     ...
                     <li class="list-group-item" style="background:#6f93b7" >
                      <table>
                        <tbody>
                          <tr>
                            <td><h1 style="margin:0; font-size:56px; color:#fff; font-weight:bold;  margin-right:15px; text-align:center;">02</h1></td>
                            <td><div style="font-size:18px; "> <a href="" style="color:#fff;">   Homens encapuzados interceptam veículo e matam suspeito de  </a>  </div></td>
                          </tr>
                     ...
                     <li class="list-group-item" style="background:#6f93b7" >
                      <table>
                        <tbody>
                          <tr>
                            <td><h1 style="margin:0; font-size:56px; color:#fff; font-weight:bold;  margin-right:15px; text-align:center;">03</h1></td>
                            <td><div style="font-size:18px; "> <a href="" style="color:#fff;">   Homens encapuzados interceptam veículo e matam suspeito de  </a>  </div></td>
                          </tr>
...
<footer>
  <div class="" style="background: #00468c; margin-top: 30px;  ">
      <div class="container">
        <div class="row">
              <div class="col-md-4 mt-3 mb-3 d-none d-sm-block">
                 <img src="imagens/logo.png" alt="">
              </div>

              <div class="col-md-4 mt-3 mb-3 text-center d-block d-sm-none">
                 <img src="imagens/logo.png" alt="">
              </div>
             <div class="col-md-4">
               <div class="social p-2 mt-5 text-center">
                  <div class="d-inline-block "><i class="fab fa-facebook-square fa-2x"></i></div>
                  <span class="d-sm-inline-block "><i class="fab fa-instagram fa-2x"></i></span>
                  <span class="d-md-inline-block "><i class="fab fa-youtube-square fa-2x"></i></span>
              </div>
              </div>
                
                <div class="col-md-4 float-right mt-5 d-none d-sm-block" style="color:#fff;">
                  <h5>Copyright 2018. Todos Direitos Reservados</h5>
                </div>

                 <div class="col-md-4 text-center mt-5 d-block d-sm-none" style="color:#fff;">
                  <h5>Copyright 2018. Todos Direitos Reservados</h5>
                </div>
          </div>
      </div>        
  ...
  <script type="text/javascript">
    $(document).on('ready', function() {
      ...
      nextArrow:"<img class='a-right control-c next slick-next' src='imagens/arrow-right.jpg'>",
        dots: true,
        infinite: true,
        slidesToShow: 3,
        slidesToScroll: 3,
